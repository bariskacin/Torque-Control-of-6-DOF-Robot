...
## 
## Makefile     : Robot.mk
## Generated on : Tue Oct 28 14:57:16 2025
## Final product: ./Robot.exe
...
PRODUCT_NAME              = Robot
MAKEFILE                  = Robot.mk
MATLAB_ROOT               = D:/Program/Matlab
MATLAB_BIN                = D:/Program/Matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/_Robot_Tasarimi/Matlab
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Robot_comp.rsp
CMD_FILE                  = Robot.rsp
...
DEFINES_STANDARD = -DMODEL=Robot -DNUMST=1 -DNCSTATES=12 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_create.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_setParameters.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_asserts.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_deriv.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_checkDynamics.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_compOutputs.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_asm_delegate.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_sim_delegate.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_mode_zero_crossings.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_logging.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_geometries.c $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_1_gateway.c $(START_DIR)/slprj/raccel/Robot/rt_backsubrr_dbl.c $(START_DIR)/slprj/raccel/Robot/rt_forwardsubrr_dbl.c $(START_DIR)/slprj/raccel/Robot/rt_lu_real.c $(START_DIR)/slprj/raccel/Robot/rt_matrixlib_dbl.c $(START_DIR)/slprj/raccel/Robot/Robot.c $(START_DIR)/slprj/raccel/Robot/Robot_capi.c $(START_DIR)/slprj/raccel/Robot/Robot_data.c $(START_DIR)/slprj/raccel/Robot/Robot_tgtconn.c $(START_DIR)/slprj/raccel/Robot/rtGetInf.c $(START_DIR)/slprj/raccel/Robot/rtGetNaN.c $(START_DIR)/slprj/raccel/Robot/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/raccel/main.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = Robot_d319c82e_49.obj Robot_d319c82e_49_create.obj Robot_d319c82e_49_setParameters.obj Robot_d319c82e_49_asserts.obj Robot_d319c82e_49_deriv.obj Robot_d319c82e_49_checkDynamics.obj Robot_d319c82e_49_compOutputs.obj Robot_d319c82e_49_asm_delegate.obj Robot_d319c82e_49_sim_delegate.obj Robot_d319c82e_49_mode_zero_crossings.obj Robot_d319c82e_49_logging.obj Robot_d319c82e_49_geometries.obj Robot_d319c82e_1_gateway.obj rt_backsubrr_dbl.obj rt_forwardsubrr_dbl.obj rt_lu_real.obj rt_matrixlib_dbl.obj Robot.obj Robot_capi.obj Robot_data.obj Robot_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj main.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/Robot/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Robot/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Robot/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Robot/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Robot/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Robot_d319c82e_49.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_create.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_create.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_setParameters.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_setParameters.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_asserts.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_asserts.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_deriv.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_deriv.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_checkDynamics.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_checkDynamics.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_compOutputs.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_compOutputs.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_asm_delegate.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_asm_delegate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_sim_delegate.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_sim_delegate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_mode_zero_crossings.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_mode_zero_crossings.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_logging.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_logging.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_49_geometries.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_49_geometries.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_d319c82e_1_gateway.obj : $(START_DIR)/slprj/raccel/Robot/Robot_d319c82e_1_gateway.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_backsubrr_dbl.obj : $(START_DIR)/slprj/raccel/Robot/rt_backsubrr_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_forwardsubrr_dbl.obj : $(START_DIR)/slprj/raccel/Robot/rt_forwardsubrr_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_lu_real.obj : $(START_DIR)/slprj/raccel/Robot/rt_lu_real.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_matrixlib_dbl.obj : $(START_DIR)/slprj/raccel/Robot/rt_matrixlib_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot.obj : $(START_DIR)/slprj/raccel/Robot/Robot.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_capi.obj : $(START_DIR)/slprj/raccel/Robot/Robot_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_data.obj : $(START_DIR)/slprj/raccel/Robot/Robot_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_tgtconn.obj : $(START_DIR)/slprj/raccel/Robot/Robot_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/Robot/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/Robot/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/Robot/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
